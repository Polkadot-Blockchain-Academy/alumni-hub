...
export const DappName = "Polkadot Blockchain Academy - Alumni Hub"
export const PolkadotUrl =
  "https://polkadot-blockchain-academy.github.io/alumni-hub"

export const GithubOwner = "polkadot-blockchain-academy"
export const GithubApiUrl = `https://api.github.com/repos/${GithubOwner}`
